...
# Load Lottie animations for churn and not churn scenarios
...
if st.session_state.start:
 ...
 # Display Lottie animation on the start screen
    ...
    # Display an introductory Lottie animation (optional)
    ...
    if st.button("Predict"):
        ...
        # Display result and corresponding Lottie animation
